...
public class Travel {
    ...
    public String toString() {
        return "Travel{" + "id=" + getId() + ", driver=" + getDriver() + ", Traveler=" + getTraveler() + ", address=" + getAddress() + ", dateOfOcurrence=" + getDateOfOcurrence() + ", price=" + getPrice() + ", annotation=" + getAnnotation() + ", payed=" + isPayed() + '}';
    }
